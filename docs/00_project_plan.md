...
| 1 | Data pipeline + eval protocol | metrics module, full-ranking evaluator | next |
| 2 | Baselines: Pop / ItemCF / MF-BPR | results table v1 | |
| 3 | LightGCN reproduction | Recall@20 within ~5% of 0.183 | |
