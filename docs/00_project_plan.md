...
| 10 | Engineering reliability (RNG, idempotent results, smoke tests) | test suite | **done** — 28 tests passing: persistence guard, λ=0 equivalence, idempotent summary.csv, RNG-exact resume, evaluator hand-computation, SASRec padding/NaN, ANN consistency, CPU smoke pipeline; see commit for the summary.csv CSV-quoting bug this work caught |
